...
func PostgresQuery[RowType any](query string, args ...interface{}) ([]RowType, error) {
	var result []RowType
	err := pgxscan.Select(context.Background(), FocFunBackend.Databases.Postgres, &result, query, args...)
	if err != nil {
		return nil, err
	}
...
func PostgresQueryOne[RowType any](query string, args ...interface{}) (*RowType, error) {
	var result RowType
	err := pgxscan.Get(context.Background(), FocFunBackend.Databases.Postgres, &result, query, args...)
	if err != nil {
		return nil, err
	}
